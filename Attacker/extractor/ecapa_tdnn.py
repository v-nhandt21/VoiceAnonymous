    ...
    def __init__(self, feat_dim=80, channels=512, emb_dim=192, global_context_att=False,
        ...
        if feat_type == 'fbank':
            ...
            if config_path is None:
                ...
                self.feature_extract = torch.hub.load('/Data3-Processing/nhandt23_bk/VoiceAnonymous/Attacker/extractor/s3prl_module', 'wavlm_large', source='local')
                # print(">>>>>>>>>.self.feature_extract: ", type(self.feature_extract))
            else:
                from .wavlm.expert import UpstreamExpert
            ...
            self.feat_num = 25 # self.get_feat_num()
    ...
    def get_feat(self, x):
        if self.update_extract:
            ...
            with torch.no_grad():
                ...
                # print(">>>>>>>>>feat_type: ", self.feat_type)
