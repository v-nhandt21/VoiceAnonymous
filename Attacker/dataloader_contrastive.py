...
class AudioDataset(Dataset):
     def __init__(self, wav_scp_anon, wav_scp_original, sample_rate=16000, max_length=160000):
          ...
          self.spk2utt = self.load_spk2utt("/Data3-Processing/nhandt23_bk/VoiceAnonymous/DATA/T12-5/data/train-clean-360_T12-5/spk2utt")
     ...
     def __getitem__(self, idx):
          ...
          return anon_path_waveform_pos, anon_path_waveform_neg, orig_path_waveform, spk_pos_id
